...
# Function to generate unique player IDs for up to 1,000,000 participants
def generate_unique_ids(n):
    return random.sample(range(1000000), n)  # Ensures unique IDs

# Generate unique IDs for players
player_ids = generate_unique_ids(NUM_PARTICIPANTS)
...
for i in range(NUM_PARTICIPANTS):
    ...
    ranking = random.randint(1, 3000)  # Random ranking score
